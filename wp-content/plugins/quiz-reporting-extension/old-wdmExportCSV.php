...
$wdm_export_data = isset( $_REQUEST[ 'wdm_export_data' ] ) ? ( $_REQUEST[ 'wdm_export_data' ] ) : '';
//User name
$wdm_uname		 = isset( $_REQUEST[ 'wdm_uname' ] ) ? ( $_REQUEST[ 'wdm_uname' ] ) : '';
//Quiz Title
$wdm_quiz		 = isset( $_REQUEST[ 'wdm_quiz' ] ) ? ( $_REQUEST[ 'wdm_quiz' ] ) : '';
//Format of Export
...
if ( $wdm_export_data !== '' && $wdm_format !== '') {
	...
	if ( $wdm_format === 'csv' ) {
		...
		$html	 = str_get_html( $wdm_export_data );
