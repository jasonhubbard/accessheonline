...
class WpProQuiz_View_FrontQuiz extends WpProQuiz_View_View {
	...
	private function showCheckPageBox( $questionCount ) {
		...
		<div class="wpProQuiz_checkPage" style="display: none;">
			...
			<input type="button" name="endQuizSummary" value="<?php _e( 'Finish quiz', 'wp-pro-quiz' ); ?>"
	...
	private function showInfoPageBox() {
		...
		<div class="wpProQuiz_infopage" style="display: none;">
			...
			<input type="button" name="endInfopage" value="<?php _e( 'Finish quiz', 'wp-pro-quiz' ); ?>"
			       class="wpProQuiz_button">
		</div>
		<?php
	}
	...
	private function showStartQuizBox() {
		...
		<div class="wpProQuiz_text">
			...
			<div>
				<input class="wpProQuiz_button" type="button" value="<?php _e( 'Start quiz', 'wp-pro-quiz' ); ?>"
				       name="startQuiz">
			</div>
		</div>
		<?php
			...
			<div>
				<?php if ( $this->quiz->getQuizModus() != WpProQuiz_Model_Quiz::QUIZ_MODUS_SINGLE ) { ?>
					...
					<?php if ( ! $this->quiz->isQuizSummaryHide() ) { ?>
						<input type="button" name="quizSummary" value="<?php _e( 'Quiz-summary', 'wp-pro-quiz' ); ?>"
			...
			<div style="margin: 10px 0px;">
				...
				<?php if ( ! $this->quiz->isBtnRestartQuizHidden() ) { ?>
					<input class="wpProQuiz_button" type="button" name="restartQuiz"
					       value="<?php _e( 'Restart quiz', 'wp-pro-quiz' ); ?>">
				<?php }
				if ( ! $this->quiz->isBtnViewQuestionHidden() ) { ?>
					<input class="wpProQuiz_button" type="button" name="reShowQuestion"
					       value="<?php #_e( 'View questions', 'wp-pro-quiz' ); ?>View answers">
				<?php } ?>
			...
			<?php if ( $this->quiz->getQuizModus() == WpProQuiz_Model_Quiz::QUIZ_MODUS_SINGLE ) { ?>
				<div>
					...
					<?php if ( $this->quiz->isShowReviewQuestion() && ! $this->quiz->isQuizSummaryHide() ) { ?>
						<input type="button" name="checkSingle" value="<?php _e( 'Quiz-summary', 'wp-pro-quiz' ); ?>"
						       class="wpProQuiz_button wpProQuiz_QuestionButton" style="float: right;">
					<?php } else { ?>
						<input type="button" name="checkSingle" value="<?php _e( 'Finish quiz', 'wp-pro-quiz' ); ?>"
						       class="wpProQuiz_button wpProQuiz_QuestionButton" style="float: right;">
					<?php } ?>
