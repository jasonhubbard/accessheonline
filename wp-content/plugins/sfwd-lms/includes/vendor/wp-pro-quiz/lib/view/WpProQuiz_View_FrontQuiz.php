		...
		<div style="display: none;" class="wpProQuiz_results">
			<h4 class="wpProQuiz_header"><?php _e('Results', 'wp-pro-quiz'); ?></h4>
				...
				<div style="margin: 10px 0px;">
					...
					<input class="wpProQuiz_button" type="button" name="reShowQuestion" value="<?php #_e('View questions', 'wp-pro-quiz'); ?>View answers">
					<?php } ?>
				...
				<li class="wpProQuiz_listItem" style="display: none;">
					...
					<div class="wpProQuiz_question" style="margin: 10px 0px 0px 0px;">
						<div class="wpProQuiz_question_text">
							<span><?php echo $index; ?></span>. <?php echo do_shortcode(apply_filters('comment_text', $question->getQuestion())); ?>
						</div>
