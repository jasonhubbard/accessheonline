...
class Mega_Menu_Updater {
	...
	public function edd_mmm_activate_license() {
		...
		if ( is_wp_error( $response ) ) {
        	wp_redirect( admin_url( "themes.php?page=megamenu_settings&tab=license&activated=error" ) );
        	exit;
		}
        ...
        wp_redirect( admin_url( "themes.php?page=megamenu_settings&tab=license&activated={$license_data->license}" ) );
        exit;
	}
	...
	public function edd_mmm_deactivate_license() {
		...
		// make sure the response came back okay
		if ( is_wp_error( $response ) ) {
	        wp_redirect( admin_url( "themes.php?page=megamenu_settings&tab=license&deactivated=error" ) );
	        exit;
		}
        ...
        wp_redirect( admin_url( "themes.php?page=megamenu_settings&tab=license&deactivated={$license_data->license}" ) );
        exit;
