...
class Mega_Menu_Pro {
	...
	public function enqueue_nav_menu_scripts() {
		...
		$params = array(
			'file_frame_title' => __("Choose custom icon", "megamenupro"),
            'file_frame_title_background' => __("Choose background image", "megamenupro")
		);
    ...
    public function check_megamenu_is_installed() {
	    ...
	    <div class="updated">
	        <p>
	        	<?php _e( 'Max Mega Menu Pro requires Max Mega Menu (free). Please activate the Max Mega Menu plugin.', 'megamenu' ); ?>
	        </p>
	        <p class='submit'>
	        	<a href="<?php echo admin_url( "plugins.php" ) ?>" class='button button-secondary'><?php _e("Enable Max Mega Menu", "megamenupro"); ?></a>
	        </p>
	    </div>
	    <?php
