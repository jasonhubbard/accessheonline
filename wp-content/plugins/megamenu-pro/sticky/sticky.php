...
class Mega_Menu_Sticky {
	...
	public function enqueue_public_scripts() {
		...
		if ( isset( $settings['sticky'] ) && $settings['sticky'] != 'disabled') {
	        wp_enqueue_script( 'megamenu-sticky', plugins_url( 'js/sticky.js' , __FILE__ ), array('jquery'), MEGAMENU_PRO_VERSION );
		}
