...
<?php if ( $logged_in ) : ?>
	...
	<?php  if ( ! empty( $course_certficate_link ) ) : ?>
        ...
        <p class="module-instruction">Congratulations, you have completed the course!</p>
			<a href='<?php echo esc_attr( $course_certficate_link ); ?>' class="button" target="_blank"><?php _e( 'PRINT YOUR CERTIFICATE!', 'learndash' ); ?></a>
		</div>
		<br />
	<?php endif; ?>
<?php endif; ?>
