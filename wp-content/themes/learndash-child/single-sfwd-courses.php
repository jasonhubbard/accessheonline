		...
		<div class="row">
			<div class="col-md-4 col-sd-6 text-center">
				<?php if(has_post_thumbnail()) :
					 $authorurl= get_field('course_author_url');
                     if($authorurl){ ?>
				<a href="<?php echo $authorurl; ?>" target="_blank"><?php the_post_thumbnail('course-thumb', array('class' => 'thumbnail')); ?></a>
                	<?php } else { 
						the_post_thumbnail('course-thumb', array('class' => 'thumbnail'));
					 } ?>
				<?php else :?>
